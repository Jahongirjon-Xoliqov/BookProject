...
extension NSAttributedString {
    ...
    static func getMainBoldFont(text: String, size: CGFloat, color: UIColor) -> NSAttributedString {
        let attrs: [NSAttributedString.Key: Any] = [
    ...
    static func getSystemFont(text: String, size: CGFloat, color: UIColor) -> NSAttributedString {
        let attrs: [NSAttributedString.Key: Any] = [
